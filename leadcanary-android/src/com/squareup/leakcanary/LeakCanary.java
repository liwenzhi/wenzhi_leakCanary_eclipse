...
public final class LeakCanary {
  ...
  @SuppressLint("NewApi") public static String leakInfo(Context context, HeapDump heapDump, AnalysisResult result,
      boolean detailed) {
    ...
    if (result.leakFound) {
      ...
      // the stacktrace.
      info += "* FAILURE in " + "1.4-SNAPSHOT" + " " + ":" + Log.getStackTraceString(
          result.failure) + "\n";
    } else {
      info += "* NO LEAK FOUND.\n\n";
    }
